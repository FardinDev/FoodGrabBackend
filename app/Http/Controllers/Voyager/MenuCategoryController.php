...
class MenuCategoryController extends VoyagerBaseController
{
...
if (Auth::user()->hasRole('Restaurant Owner')) {
    ...
    $query->where('restaurant_id', Auth::user()->restaurants->first()->id)->where("status", 1);
}
// auth check 
    ...
    public function destroy(Request $request, $id)
    {
        ...
        //     $itemsIds = Item::where('restaurant_id', Auth::user()->restaurants->first()->id)->get('id')->pluck('id')->toArray();
        // }
        // auth check 
